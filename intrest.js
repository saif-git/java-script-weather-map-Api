document.getElementById('ajout').addEventListener('click', addPost);
...
function addPost() {
    ...
    http.setRequestHeader('Content-type', data);
...
/*function addPost() {
    ...
    var laungeur = country.push(document.getElementById('interest').value);
    console.log(laungeur);
    console.log(country);
...
function addPost(e) {
    ...
    var intrest = document.getElementById('interest').value;
    var code = document.getElementById('code').value;
    console.log(intrest);
    ...
    fetch('country2.json', {
            ...
            body: JSON.stringify({ name: intrest, code: code })
        })
        .then((res) => res.json())
        .then((data) => console.log(data))

    console.log('ajoute des plusieur choose');
}*/